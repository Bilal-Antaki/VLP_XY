"""
RNN model for trajectory prediction with proper sequence handling
"""
...
class RNNNetwork(nn.Module):
    """
    RNN with batch normalization and dropout
    """
...
class RNNModel:
    """
    RNN wrapper for trajectory prediction
    ...
    def fit(self, X, y):
        ...
        self.model = RNNNetwork(input_size, self.hidden_dim, self.num_layers, self.dropout)
